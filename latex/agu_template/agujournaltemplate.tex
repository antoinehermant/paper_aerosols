...
\title{Possible Causes of Increasing Aerosol Direct Effect Despite Declining Emissions in Recent Decades.}
...
\authors{Antoine Hermant\affil{1}, Linnea Huusko\affil{2}, Thorsten Mauritsen\affil{2}}
...
\section{Introduction}
      ...
      Several local factors can influence the aerosol forcing such as surface albedo, clouds, zenith angle, transport. Furthermore, \citeA{Huusko_2022} demonstrated that the indirect effect of aerosols induces a stronger response due to cooling in remote regions. This highlights the importance of aerosol distribution in shaping the resulting forcing and cooling effect.
